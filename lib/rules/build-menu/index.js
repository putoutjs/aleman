...
const createMenuItemFirst = template(`
...
export const fix = ({path, menu}) => {
    const [[firstName], ...rest] = entries(menu);
    
    const firstMenuItem = createMenuItemFirst();
    
    firstMenuItem.children[1].children[0].value = firstName;
    const items = [INDENT, firstMenuItem];
