...
The original source entry points and their esm.sh loading paths are unchanged. The legacy bundle uses a separate CSS wrapper so no modification to `menu/` is needed.
